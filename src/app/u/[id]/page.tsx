...
const page = (context) => {
  ...
  return <div className="mt-14 flex flex-col w-full h-auto">
    <div className="w-full h-64 bg-gradient-to-tr from-purple-600 to-pink-600/50 relative">
      <div className="w-full h-full relative group hover:cursor-pointer">
        <Camera className="absolute right-12 top-8 hidden group-hover:flex text-white"  size={32} strokeWidth={1}></Camera>
      </div>
